        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    console.log("Name: ".concat(updatedUser.firstName, " ").concat(updatedUser.lastName));
                    console.log("Role: ".concat(updatedUser.role));
                    console.log("User ID: ".concat(updatedUser.id));
                    console.log('');
                    console.log('This user can now access admin endpoints!');
                    return [3 /*break*/, 6];
                case 3:
                    error_1 = _a.sent();
                    console.error('❌ Error making user admin:', error_1);
                    return [3 /*break*/, 6];
