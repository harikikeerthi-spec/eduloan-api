    ...
    const stories = await Promise.all([
        ...
        prisma.successStory.create({
            data: {
                ...
                interestRate: '7.2%',
                story:
                    'Germany was a smart choice — tuition is almost free! I only needed a loan for living expenses and blocked account requirements. Bank of Baroda offered the lowest interest rate. The mentor I was connected with through VidyaLoan guided me through the German visa process, which is quite different from US/UK applications.',
        ...
        prisma.successStory.create({
            data: {
                ...
                interestRate: '7.5%',
                story:
                    'As a PhD student, I had a research assistantship that covered most of my tuition. I needed a loan primarily for the first year before the funding kicked in. PNB was very supportive of PhD applications. Now in my third year, I\'ve already started repaying thanks to my RA stipend. VidyaLoan\'s EMI calculator helped me plan my finances perfectly.',
    ...
    const resources = await Promise.all([
        prisma.communityResource.create({
            data: {
                ...
                downloads: 2340,
                isFeatured: true,
                fileUrl: 'https://resources.VidyaLoan.com/country-wise-comparison-2026.pdf',
                downloadUrl: 'https://resources.VidyaLoan.com/download/country-wise-comparison-2026.pdf',
        ...
        prisma.communityResource.create({
            data: {
                ...
                downloads: 1780,
                isFeatured: true,
                fileUrl: 'https://resources.VidyaLoan.com/sop-guide.pdf',
                downloadUrl: 'https://resources.VidyaLoan.com/download/sop-guide.pdf',
            },
        }),
        prisma.communityResource.create({
            data: {
                ...
                downloads: 1450,
                isFeatured: false,
                fileUrl: 'https://resources.VidyaLoan.com/section-80e-guide.mp4',
        ...
        prisma.communityResource.create({
            data: {
                ...
                downloads: 980,
                isFeatured: false,
                fileUrl: 'https://resources.VidyaLoan.com/pre-departure-checklist.pdf',
                downloadUrl: 'https://resources.VidyaLoan.com/download/pre-departure-checklist.pdf',
            },
        }),
        prisma.communityResource.create({
            data: {
                ...
                downloads: 670,
                isFeatured: false,
                fileUrl: 'https://resources.VidyaLoan.com/collateral-guide.pdf',
                downloadUrl: 'https://resources.VidyaLoan.com/download/collateral-guide.pdf',
            },
        }),
        prisma.communityResource.create({
            data: {
                ...
                downloads: 1120,
                isFeatured: true,
                fileUrl: 'https://resources.VidyaLoan.com/budget-planner.xlsx',
                downloadUrl: 'https://resources.VidyaLoan.com/download/budget-planner.xlsx',
        ...
        prisma.communityResource.create({
            data: {
                ...
                downloads: 890,
                isFeatured: false,
                fileUrl: 'https://resources.VidyaLoan.com/bank-interview-guide.pdf',
                downloadUrl: 'https://resources.VidyaLoan.com/download/bank-interview-guide.pdf',
            },
        }),
    ]);
