        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    if (user.role !== 'admin') {
                        console.log("\u26A0\uFE0F  WARNING: This user is NOT an admin (Role: ".concat(user.role, ")."));
                        console.log("   The token will be valid, but admin endpoints will return 403 Forbidden.");
                        console.log("   Run 'npx ts-node scripts/make-admin.ts ".concat(email, "' first."));
                    }
                    payload = {
                        email: user.email,
                        sub: user.id,
                    ...
                    console.log("curl -X GET \"http://localhost:3000/blogs/admin/all\" -H \"Authorization: Bearer ".concat(token, "\""));
                    return [3 /*break*/, 5];
                case 2:
                    error_1 = _a.sent();
