...
var AuditController = function () {
    ...
    var AuditController = _classThis = /** @class */ (function () {
        ...
        AuditController_1.prototype.getRecentActivity = function (limit) {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.auditService.getRecentActivity(limitNum)];
    ...
    (function () {
        ...
        _getRecentActivity_decorators = [(0, common_1.Get)('activity'), (0, common_1.UseGuards)(admin_guard_1.AdminGuard)];
