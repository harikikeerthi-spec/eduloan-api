...
var EligibilityService = function () {
    ...
    var _classThis;
    var EligibilityService = _classThis = /** @class */ (function () {
        function EligibilityService_1(openRouterService) {
            this.openRouterService = openRouterService;
            this.logger = new common_1.Logger(EligibilityService.name);
        }
        EligibilityService_1.prototype.calculateEligibilityScore = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            this.logger.error('Eligibility check failed', error_1);
                            // Fallback
                            return [2 /*return*/, {
                                    score: 0,
                                    status: 'error',
        ...
        return EligibilityService_1;
    }());
    __setFunctionName(_classThis, "EligibilityService");
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
        EligibilityService = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return EligibilityService = _classThis;
}();
