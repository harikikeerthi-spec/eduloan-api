...
exports.VisaInterviewService = void 0;
...
let VisaInterviewService = class VisaInterviewService {
    openRouterService;
...
- Cover all 11 topics before ending the interview.`;
    ...
    buildPrompt(userProfile, visaType, currentSection, historyContext = '', agentType = 'agent_michael') {
...
5. Keep it natural and under 4 sentences total.`;
    ...
    async startInterview(userProfile, visaType, agentType) {
    ...
    async continueInterview(userProfile, visaType, previousQuestion, transcript, currentSection, conversationHistory, agentType = 'agent_michael') {
        let historyContext = '';
    ...
    async evaluateAnswer(visaType, question, transcript) {
...
Return ONLY valid JSON. No markdown, no explanation.`;
    ...
    async generateFinalReport(visaType, conversationHistory, evaluations, interviewStopped) {
...
exports.VisaInterviewService = VisaInterviewService;
exports.VisaInterviewService = VisaInterviewService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [openrouter_service_1.OpenRouterService])
], VisaInterviewService);
//# sourceMappingURL=visa-interview.service.js.map