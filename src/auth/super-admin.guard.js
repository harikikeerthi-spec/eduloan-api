...
var SuperAdminGuard = function () {
    ...
    var _classThis;
    var SuperAdminGuard = _classThis = /** @class */ (function () {
        function SuperAdminGuard_1(jwtService, usersService) {
            this.jwtService = jwtService;
            this.usersService = usersService;
        }
        SuperAdminGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, authHeader, _a, type, token, payload, user, error_1;
                    ...
                    switch (_b.label) {
                        ...
                        case 3:
                            ...
                            if (user.role !== 'super_admin') {
                                throw new common_1.ForbiddenException('Access denied. Super Admin privileges required.');
                            }
        ...
        return SuperAdminGuard_1;
    }());
    __setFunctionName(_classThis, "SuperAdminGuard");
    (function () {
