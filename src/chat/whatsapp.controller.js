...
var WhatsappController = function () {
    var _classDecorators = [(0, common_1.Controller)('webhook/whatsapp')];
    var _classDescriptor;
    var _classExtraInitializers = [];
    var _classThis;
    var _instanceExtraInitializers = [];
    var _handleIncomingMessage_decorators;
    var _getHistory_decorators;
    var WhatsappController = _classThis = /** @class */ (function () {
        function WhatsappController_1(chatService, chatGateway) {
            this.chatService = (__runInitializers(this, _instanceExtraInitializers), chatService);
            this.chatGateway = chatGateway;
            this.logger = new common_1.Logger(WhatsappController.name);
        }
        WhatsappController_1.prototype.handleIncomingMessage = function (req, res, body) {
            return __awaiter(this, void 0, void 0, function () {
                var from, content, mediaUrl, conversation, msg, type, twiml, error_1;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            ...
                            this.logger.log("Incoming WhatsApp payload: ".concat(JSON.stringify(body)));
                            from = body.From;
                            content = body.Body;
                            mediaUrl = body.MediaUrl0;
                            if (!from || (!content && !mediaUrl)) {
                                return [2 /*return*/, res.status(400).send('Invalid payload')];
                            }
                            _b.label = 1;
                        case 1:
                            _b.trys.push([1, 4, , 5]);
                        ...
                        case 3:
                            ...
                            this.chatGateway.server.to("conv_".concat(conversation.id)).emit('new_message', msg);
                        ...
                        case 4:
                            error_1 = _b.sent();
                            this.logger.error('Failed to process incoming WhatsApp message', error_1);
        ...
        WhatsappController_1.prototype.getHistory = function (phone) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.chatService.getMessagesByPhone(phone)];
                });
            });
        };
    ...
    (function () {
        ...
        _handleIncomingMessage_decorators = [(0, common_1.Post)()];
        _getHistory_decorators = [(0, common_1.Get)('history/:phone')];
        __esDecorate(_classThis, null, _handleIncomingMessage_decorators, { kind: "method", name: "handleIncomingMessage", static: false, private: false, access: { has: function (obj) { return "handleIncomingMessage" in obj; }, get: function (obj) { return obj.handleIncomingMessage; } }, metadata: _metadata }, null, _instanceExtraInitializers);
