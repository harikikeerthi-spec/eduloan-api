...
let DigilockerController = class DigilockerController {
    digilockerService;
    usersService;
    supabase;
    constructor(digilockerService, usersService, supabase) {
    ...
    async authorize(userId, docType, source, res) {
        if (!userId)
    ...
    getMockLoginPage(state, res) {
        ...
        const isPinless = decodedState.authMethod === 'pinless';
        const html = `
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    normalizeDigilockerType(rawDoc) {
        const candidates = [
            rawDoc?.doctype,
            rawDoc?.type,
            rawDoc?.docType,
    ...
    async processMockDocuments(userId, docType) {
    ...
    async fetchAndStoreDocuments(userId, accessToken, docType) {
...
], DigilockerController.prototype, "getStatus", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DigilockerController.prototype, "authorize", null);
__decorate([
...
], DigilockerController.prototype, "getMockLoginPage", null);
__decorate([
    (0, common_1.Post)('mock/send-otp'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DigilockerController.prototype, "mockSendOtp", null);
__decorate([
    (0, common_1.Post)('mock/verify-otp'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DigilockerController.prototype, "mockVerifyOtp", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], DigilockerController.prototype, "handleCallback", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], DigilockerController.prototype, "syncDocument", null);
exports.DigilockerController = DigilockerController = __decorate([
    (0, common_1.Controller)('digilocker'),
    __metadata("design:paramtypes", [digilocker_service_1.DigilockerService,
        users_service_1.UsersService,
        supabase_service_1.SupabaseService])
], DigilockerController);
//# sourceMappingURL=digilocker.controller.js.map